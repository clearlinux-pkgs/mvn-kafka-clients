...
Source1  : https://repo1.maven.org/maven2/org/apache/kafka/kafka-clients/2.0.0/kafka-clients-2.0.0.pom
...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/apache/kafka/kafka-clients/2.0.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/kafka/kafka-clients/2.0.0
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/org/apache/kafka/kafka-clients/2.0.0
